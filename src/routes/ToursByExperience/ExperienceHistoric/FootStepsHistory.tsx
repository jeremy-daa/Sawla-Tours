...
import Axum4 from "../../../assets/axum_4.jpg";
import Axum5 from "../../../assets/axum_5.jpg";
...
import Gonder4 from "../../../assets/gonder_4.jpg";
import Lalibela4 from "../../../assets/lalibela_4.jpg";
import Lalibela6 from "../../../assets/lalibela_6.jpg";
import Addis2 from "../../../assets/addis_2.jpg";

const FootStepsHistory = () => {
  //extract a single element from the array with title containing the text Footsteps of History
  const Package = HistoricAndCulturalToursArray.filter((item) => {
    if (item.title.includes("Footsteps of History")) {
      return item;
    } else {
      return null;
    }
